    ...
    return (
        <article className="about-us">
            <section className="hero-text">
                <h1>Little Lemon</h1>
                <h2>Chicago</h2>
                <p className="about-subtext">Little Lemon opened in 2015 by two brothers, john and kate. 
                Despite the city's diversity, the two brothers recognized the lack of Mediterranean cuisine in london, 
                and were inspired to bring the flavors of their hometown in Italy to the people of US. The two brothers 
